...
<div class="site_wrapper">
      ...
      <div class="navbar green navbar-default yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav green navbar-nav">
            ...
            <li><a href="properties.html" class="dropdown-toggle active">Properties</a></li>
            <li><a href="gallery.html" class="dropdown-toggle">Gallery</a></li>
            <li><a href="agents.html" class="dropdown-toggle">Agents</a></li>
  ...
  <section>
    <div class="header-inner two">
      ...
      <img src="images/page-header.jpg" alt="" class="img-responsive"/> </div>
  </section>
  <!-- end header inner -->
  <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="carousel_holder">
          ...
          <div id="sync2" class="owl-carousel">
            <div class="item "><img src="http://placehold.it/150x80" alt=""/></div>
            <div class="item"><img src="http://placehold.it/150x80" alt=""/></div>
            <div class="item"><img src="http://placehold.it/150x80" alt=""/></div>
            <div class="item"><img src="http://placehold.it/150x80" alt=""/></div>
            <div class="item"><img src="http://placehold.it/150x80" alt=""/></div>
      ...
      <br/><br/>
            ...
            <div class="feature-box-66 border">
              ...
              <div class="text-box-inner">
                ...
                <div class="property-info">
                  ...
                  <div class="pull-right"><span><i class="fa fa-tasks"></i> 100 ft2</span> <span><i class="fa fa-Livestock"></i> 100 ft2</span></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-3">
          ...
          <ul class="category-list">
            <li><a href="#">Apartments <span class="pull-right">20</span></a></li>
            <li><a href="#">Offices <span class="pull-right">80</span></a></li>
            <li><a href="#">Villas <span class="pull-right">50</span></a></li>
            <li><a href="#">Residentials <span class="pull-right">60</span></a></li>
            <li><a href="#">Videos <span class="pull-right">30</span></a></li>
          </ul>
        </div>
        <!--end right--> 
